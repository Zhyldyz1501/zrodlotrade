...
import { portfolioDataEquipment } from "../../mocks/Data/data";
import Link from "next/link";
import Image from "next/image";
import { FiCamera } from "react-icons/fi";
import Lightbox from "react-18-image-lightbox";

function Products_Equipment() {
      const [currentImageIndex, setCurrentImageIndex] = useState(0);
      const [isImage, setIsImage] = useState(false);

   const images = [
     "/images/pasterizator-005.png",
     "/images/separator-normalizator-25000litrov.jpg",
     "/images/normalizator.jpg",
     "/images/press.jpg",
   ];
  ...
  return (
    <div id="products" className="container relative md:mt-20 mt-10">
      <div className="grid grid-cols-1 pb-8 text-center">
        ...
        Our company actively cooperates with European manufacturers of various equipment for processing vegetables/fruits, production of dairy products, soft drinks and much more.
        <br/>
        You can leave us a request for what equipment or spare parts you need and our team will definately provide you with favorable offer. 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-6 mt-8">
        {portfolioDataEquipment.map((item, index) => {
          return (
            <div
              key={index}
...
export default Products_Equipment;
