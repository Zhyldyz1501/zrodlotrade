...
import { clientsData } from "../../mocks/Data/data";

const TinySlider = dynamic(() => import("tiny-slider-react"), { ssr: false });
import "../../../../node_modules/tiny-slider/dist/tiny-slider.css"; //tiny-slider/dist/tiny-slider.css

 const ClientsOne = ({ title, clients }) => {
  const settings = {
