...
import {portfolioDataCargo} from "../../mocks/Data/data";

function Products_Avia() {
      const [currentImageIndex, setCurrentImageIndex] = useState(0);
      const [isImage, setIsImage] = useState(false);

   const images = [
    "/images/iStock-cargo.jpg",
    "/images/international-air.webp",
     "/images/cargo.jpg",
     "/images/air-cargo.jpg",
   ];
  ...
  return (
    <div id="products" className="container relative md:mt-20 mt-10">
      <div className="grid grid-cols-1 pb-8 text-center">
        ...
        We provide reliable air and road transport services from the European Union to Central Asia.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-6 mt-8">
        {portfolioDataCargo.map((item, index) => {
          return (
            <div
              key={index}
